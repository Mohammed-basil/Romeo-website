                        ...
                        <!-- BEGIN PAGE BAR -->
                         <div style="margin-left:0.1% ;margin-right:0.1% ;margin-top:-5px;" class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span> تنشيط حسابات المكاتب </span>
                                </li>
                            </ul>
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <thead>
                                                ...
                                                <th style="font-size: 14px;text-align:center">#</th>
                                                    ...
                                                    <th style="font-size: 14px;text-align:center" >اسم المكتب  </th>
                                                    <th style="font-size: 14px;text-align:center"> الدولة </th>
                                                    <th style="font-size: 14px;text-align:center"> العنوان </th>
                                            ...
                                            @include('admin.search.offices_active')
															</tbody>
														</table>
														<input type="hidden" name="hidden_page" id="hidden_page" value="1" />
                                                        <input type="hidden" name="hidden_url" id="hidden_url" value="admin/offices_active" />
                                    </div>
