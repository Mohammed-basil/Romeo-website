...
<div class="col-md-12">
                                ...
                                <div  class="portlet-title tabbable-line">
                                             ...
                                             <div class="form-group">
															...
															<a href="/excel_admin_offices" style="float:left" class="btn green btn-outline">Excel</a>
														</div>
													</div>
                                    <div class="portlet-body">
                                        
                                        <table class="table table-striped table-hover table-bordered table_sample"  style="text-align:center">
                                        <thead>
                                        <tr>
                                        <th colspan="8"></th>
                                        ...
                                        <tr>
                                            ...
                                            @include('admin.search.offices')
															</tbody>
														</table>
														<input type="hidden" name="hidden_page" id="hidden_page" value="1" />
                                                        <input type="hidden" name="hidden_url" id="hidden_url" value="admin/offices" />
                                    </div>
