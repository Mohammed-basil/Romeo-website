...
<div class="col-md-12">
                                ...
                                <div  class="portlet-title tabbable-line">
                                              ...
                                              <div class="form-group">
															...
															<a href="/excel_admin_log" style="float:left" class="btn green btn-outline">Excel</a>
														</div>
													</div>
                                    <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered table_sample"  >
                                        <thead>
                                                ...
                                                <th style="width:10px">#</th>
                                                    <th style="width:120px" >رقم حساب المرسل  </th>
                                                    <th style="width:120px" >رقم اسم المرسل  </th>
                                                    <th style="width:120px"> رقم حساب المستقبل </th>
                                                     <th style="width:120px"> اسم المستقبل </th>
                                                    <th style="width:120px"> المبلغ</th>
                                                    <th style="width:120px"> العملة</th>
                                                    <th style="width:120px"> التاريخ</th>
                                                </tr>
                                            </thead>
                                            <tbody>                       @include('admin.search.logs')
															</tbody>
														</table>
														<input type="hidden" name="hidden_page" id="hidden_page" value="1" />
                                                        <input type="hidden" name="hidden_url" id="hidden_url" value="admin/logs" />
