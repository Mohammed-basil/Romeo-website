...
<div class="col-md-12">
                                ...
                                <div  class="portlet-title tabbable-line">
                                            ...
                                            <div class="form-group">
															...
															<a href="/excel_admin_exchange_log" style="float:left" class="btn green btn-outline">Excel</a>
														</div>
													</div>
                                    <div class="portlet-body">
                                    <table class="table table-striped table-hover table-bordered table_sample"  >
                                       <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th style="width:100px"> من</th>
                                                                                        <th style="width:100px"> الى</th>
                                                                                ...
                                                                                <tbody>
                                                                                @include('admin.search.exchangelogs')
															</tbody>
														</table>
														<input type="hidden" name="hidden_page" id="hidden_page" value="1" />
                                                        <input type="hidden" name="hidden_url" id="hidden_url" value="admin/exchangelogs" />
