@extends('layouts.include') @section('title') سجل الإيداع @endsection @section('content')
										...
										<div class="cont">
											<div class="portlet light portlet-fit bordered">
												<div class="portlet-title tabbable-line">
													<div style="width:100%; margin-bottom: 20px;" class="caption caption-md">
														...
														<div class="form-group">
															...
															<a href="/excel_deposit" style="float:left" class="btn green btn-outline">Excel</a>
														</div>
													</div>
													<div class="portlet-body">
														<table class="table table-striped table-hover table-bordered table_sample">
															...
															<tbody>
																@include('user.search.depositlogs')
															</tbody>
														</table>
														<input type="hidden" name="hidden_page" id="hidden_page" value="1" />
                                                        <input type="hidden" name="hidden_url" id="hidden_url" value="depositlogs" />
