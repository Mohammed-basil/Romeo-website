                                ...
                                <div  class="portlet-title tabbable-line">
                                                    <div style="width:100%" class="caption caption-md">
                                                        ...
                                                        <div class="form-group">
															...
															<a href="/excel_offices" style="float:left" class="btn green btn-outline">Excel</a>
														</div>
													</div>
                                    <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered table_sample">
														<thead>
															<tr>
																...
																<th style="width:100px"> العمولة الموقع</th>
																<th style="width:100px"> الحالة</th>
																<th style="width:100px"> التاريخ</th>
															</tr>
														</thead>
														<tbody>
                                                        @include('user.search.officelogs')
															</tbody>
														</table>
														<input type="hidden" name="hidden_page" id="hidden_page" value="1" />
                                                        <input type="hidden" name="hidden_url" id="hidden_url" value="officelogs" />
