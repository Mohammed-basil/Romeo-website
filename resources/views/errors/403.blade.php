...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <meta content="#1 selling multi-purpose bootstrap admin theme sold in themeforest marketplace packed with angularjs, material design, rtl support with over thausands of templates and ui elements and plugins to power any type of web applications including saas and admin dashboards. Preview page ofRTL  Theme #1 for 500 page option 2"
            name="description" />
        ...
        <link href="{{asset('css/assets/pages/css/error-rtl.min.css')}}" rel="stylesheet" type="text/css" />
         </head>
        ...
        <div class="row">
            <div class="col-md-12 page-500">
              <div class="col-md-12 page-404">
                <div class="number font-blue" style="float:right; margin-right:350px;margin-top:70px;"> 403 </div>
                   <div class="details" style="margin-top:100px;margin-left:500px;">
                    <h2>عذرًا</h2>
                    <p> هناك خطأ
                        <br/>
                    <div class=" details">
                    <br>
          					<p style="text-align:center;">
                                  <a style="width:200px;height:50px;font-size:22px" href="/login" class=" btn blue btn-outline"> رجوع </a>
                                  </p>
                          </div>
