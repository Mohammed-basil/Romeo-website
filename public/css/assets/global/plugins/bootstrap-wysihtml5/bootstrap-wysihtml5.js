            ...
            return "<li>" +
              ...
              " <div class='modal-content'>" +
                ...
                "<div class='modal-body'>" +
                  "<input value='https://' class='bootstrap-wysihtml5-insert-link-url form-control input-xlarge'>" +
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              ...
              " <div class='modal-content'>" +
                ...
                "</div>" +
                "<div class='modal-body'>" +
                  "<input value='https://' class='bootstrap-wysihtml5-insert-image-url form-control input-xlarge'>" +
                "</div>" +
                "<div class='modal-footer'>" +
