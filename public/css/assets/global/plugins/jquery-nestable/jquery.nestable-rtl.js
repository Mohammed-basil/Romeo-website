 ...
 * RTL Direction added By Alireza Maghari (maghari@gmail.com)
...
;(function($, window, document, undefined)
{
    ...
    Plugin.prototype = {
        ...
        dragStart: function(e)
        {
            ...
            //debugger;
            mouse.offsetX = e.offsetX !== undefined ? e.offsetX : e.pageX - 40 ;   // change for rtl by Alireza, original is:  mouse.offsetX = e.offsetX !== undefined ? e.offsetX : e.pageX - target.offset().left; 
			...
			movingWidth=dragItem.width()-10;
            this.dragEl.css({
                
                'left': e.pageX - mouse.offsetX-movingWidth  ,
        ...
        dragMove: function(e)
        {
            ...
            if (mouse.dirAx && mouse.distAxX >= opt.threshold) {
                ...
                if (mouse.distX < 0 && prev.length && !prev.hasClass(opt.collapsedClass)) {        // change for rtl by Alireza, original is: if (mouse.distX > 0 && prev.length && !prev.hasClass(opt.collapsedClass)) {
                ...
                if (mouse.distX > 0) {                                                             // change for rtl, original is: if (mouse.distX < 0) {
