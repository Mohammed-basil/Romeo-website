...
I have a basic demo set up at jsfiddle for the time being which you can view here: https://jsfiddle.net/ifightcrime/Us6WX/1008/

##Features

* Uses standard [Twitter Bootstrap alerts](https://twitter.github.com/bootstrap/components.html#alerts) which provides 'info', 'danger', and 'success' styles.
...
2. [Twitter Bootstrap](https://twitter.github.com/bootstrap/index.html). (current rev tested with 3.3.1)
